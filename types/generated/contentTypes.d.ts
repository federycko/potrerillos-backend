...
export interface ApiAccommodationAccommodation
  ...
  attributes: {
    ...
    microsite: Schema.Attribute.Relation<
      'manyToOne',
      'api::microsite.microsite'
    >;
    name: Schema.Attribute.String;
    ...
    price_per_night: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    price_weekend: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    type: Schema.Attribute.Enumeration<
      ['hotel', 'cabana', 'camping', 'apart-hotel', 'hostel', 'glamping']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    difficulty: Schema.Attribute.Enumeration<
      ['facil', 'moderado', 'dificil', 'experto']
    >;
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    placement: Schema.Attribute.Enumeration<
      ['home-hero', 'home-sidebar', 'section-top', 'footer']
    >;
...
export interface ApiInformationInformation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    best_times: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    faqs: Schema.Attribute.Component<'information.faq', true>;
    geography: Schema.Attribute.RichText;
    history: Schema.Attribute.RichText;
    how_to_arrive: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMicrositeMicrosite extends Struct.CollectionTypeSchema {
  collectionName: 'microsites';
  info: {
    displayName: 'Microsite';
    pluralName: 'microsites';
    singularName: 'microsite';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    custom_pages: Schema.Attribute.JSON;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    subscription_plan: Schema.Attribute.Enumeration<['basico', 'premium']> &
      Schema.Attribute.DefaultTo<'basico'>;
    theme_color: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#0066cc'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    website: Schema.Attribute.String;
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'name'>;
    type: Schema.Attribute.Enumeration<
      ['informacion', 'historia', 'geografia', 'como-llegar']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::microsite.microsite': ApiMicrositeMicrosite;
